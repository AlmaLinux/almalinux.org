...
While not many compared to the 1.3M+ of AlmaLinux OS 8 and 9, we already have a few thousand devices calling home running AlmaLinux OS Kitten 10! For a development branch, that's pretty cool. It also serves as the upstream for a couple projects, and is already helping projects based on AlmaLinux to get ready for AlmaLinux OS 10 - exactly what we were hoping for!
