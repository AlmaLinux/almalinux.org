...
- **More diversity in active contributors** — finding where we're missing opportunities to engage with underrepresented communities
...
### [Cloud SIG](https://wiki.almalinux.org/sigs/Cloud)

- Get Kiwi working across all targets (needs dedicated time and access to the build infrastructure)
- Build out more support for governance tools for cloud providers
- Set up regular meetings
- Set up a runs-on runner for AlmaLinux AI workloads
...
- Potentially expand ALBS to build ISO images
...
- Release an M&E ISO in two desktop flavors (GNOME and KDE) for both AlmaLinux 9 and 10
...
That is a massive list of goals — and we are already working on them. If you find something here that excites you, find the relevant SIG leader on [Mattermost](https://chat.almalinux.org) or via email and let them know. They would love to have every person with any interest show up in whatever capacity they want or are able.
